...
const SignupForm = ({ onSignupSuccess })=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setAuthError(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$supabase$2f$Supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUpWithEmail"])(signupData.email, signupData.password);
            if (result.error) {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        setAuthError(null);
        try {
            const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$supabase$2f$Supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithGoogle"])();
            if (error) {
                setAuthError(error.message);
                setIsLoading(false);
            }
...
_s(SignupForm, "T32/1Vcc1U3TrOO5iHKJpiiUrRw=", false, function() {
    return [
...
_s(SignupPage, "fKLMlyFH2GMrhNeUDpp+0z1yiCo=");
_c = SignupPage;
...
//# sourceMappingURL=_0038ffe3._.js.map