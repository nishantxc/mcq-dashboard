...
const LoginForm = ({ onLoginSuccess })=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setAuthError(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$supabase$2f$Supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithEmail"])(loginData.email, loginData.password);
            if (result.error) {
                setAuthError(result.error.message);
                setIsLoading(false);
                return;
            }
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$userSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adduserProfile"])(result.user));
            router.push('/home');
        } catch (error) {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        setAuthError(null);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$supabase$2f$Supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithGoogle"])();
            if (result.error) {
                setAuthError(result.error.message);
                setIsLoading(false);
                return;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2e0b88e._.js.map