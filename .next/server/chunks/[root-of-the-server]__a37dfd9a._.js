...
"[project]/.next-internal/server/app/api/questions/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET() {
    try {
        const { data: questions, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabase$2f$Supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('questions').select('*');
        if (error) throw error;
        // Randomize questions order
        // Validate the question data
        const validQuestions = questions?.filter((q)=>q && typeof q.question === 'string' && Array.isArray(q.options) && typeof q.correct_answer === 'string');
        const shuffledQuestions = validQuestions.sort(()=>Math.random() - 0.5);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(shuffledQuestions);
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$supabase$2f$Supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('questions').insert([
            {
                question,
                options,
                correct_answer
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a37dfd9a._.js.map